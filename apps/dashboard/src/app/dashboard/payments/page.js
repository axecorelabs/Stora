            ...
            <div className="flex items-center flex-wrap gap-3">
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-10 pr-4 py-2.5 w-72 bg-gray-50 border-0 rounded-xl focus:outline-none text-gray-900 focus:ring-2 focus:ring-brand-800 focus:bg-white text-sm transition-all duration-200"
                />
              </div>
