...
function OrdersPageContent() {
  ...
  return (
    <DashboardLayout title="Order Management" subtitle="Manage customer orders and fulfillment">
      ...
      {/* Stats Strip - Show cached data while loading. 2-col bento on
          mobile; the odd card out spans both columns instead of being left
          alone. Desktop/tablet unchanged. */}
      {orderStats && (
