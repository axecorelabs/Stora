...
// Bot check on signup, verified server-side -- the client-side widget token
// alone proves nothing, since it's just whatever the browser sent.
//
// Deliberately the OPPOSITE fail behavior from this app's Redis helpers
// (lib/redis.js's withTimeout, always fail-open): those guard optional
// conveniences where a miss just means "do the real work instead," but
