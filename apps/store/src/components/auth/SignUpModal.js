      ...
      <div className="bg-white rounded-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-100">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="font-display text-xl font-bold text-gray-900">Create Account</h2>
              <p className="text-sm text-gray-500 mt-0.5">Join real vendors and shoppers on Stora</p>
            </div>
          </div>
          <button
            onClick={handleClose}
        ...
        <div className="p-6">
          ...
          {/* No agreeToTerms gate here -- that checkbox only applies to the
              email/password form below; the Google path never reads it
              (see api/auth/google/start/route.js), and every brand-new
              Google signup is unconditionally routed through
              /auth/review-and-accept (enforced app-wide by
              LegalReviewGate, even if that step gets skipped) regardless
              of this checkbox's state. */}
          <a
            href={googleStartUrl}
            className="flex items-center justify-center gap-3 w-full px-4 py-2.5 border border-gray-300 rounded-lg transition-colors hover:bg-gray-50"
          >
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  placeholder="John"
                  disabled={isSubmitting}
                  className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-brand-700/20 focus:border-brand-700 text-sm text-gray-900 ${
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  disabled={isSubmitting}
                  className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-brand-700/20 focus:border-brand-700 text-sm text-gray-900 pr-10 ${
            ...
            <div>
              <div className="flex items-start">
                <input
                  ...
                  onChange={handleChange}
                  disabled={isSubmitting}
                  className="h-4 w-4 text-brand-700 focus:ring-brand-700/30 border-gray-300 rounded mt-0.5 disabled:opacity-50"
                />
