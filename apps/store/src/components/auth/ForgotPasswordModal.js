      ...
      <div className="bg-white rounded-xl max-w-md w-full">
        ...
        <div className="flex items-center justify-between p-6 border-b">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">We'll send you a reset link</p>
          </div>
          <button
            onClick={handleClose}
          ...
          {success ? (
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                disabled={isSubmitting}
                className="w-full bg-emerald-600 hover:bg-emerald-700 text-white py-3 px-4 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center font-medium mb-4"
              >
                {isSubmitting ? (
                  <>
              ...
              <button
                ...
                onClick={onBackToSignIn}
                disabled={isSubmitting}
                className="w-full flex items-center justify-center gap-2 text-emerald-600 hover:text-emerald-700 font-medium text-sm disabled:opacity-50"
              >
