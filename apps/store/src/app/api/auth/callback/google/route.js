...
// signInSocial call, which doesn't override it). Google Cloud Console's
// OAuth client needs this exact URL added as an authorized redirect URI
...
// creating a new customer if neither matches, setting the real session
// cookie, and redirecting to the callbackURL/errorCallbackURL that
// google/start/route.js configured when the flow began -- so this file
// is a thin pass-through, not a reimplementation.
